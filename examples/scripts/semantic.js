	...
	$spice(body[0])
		...
		.section().$class('ui page grid')
			...
			.div().$class('row ui one column grid')
				.div().$class('column')
					.h1().$class('ui header').text('H1 - Hello, World').close()
					.h2().$class('ui header').text('H2 - Hello, World').close()
					.h3().$class('ui header').text('H3 - Hello, World').close()
					.h4().$class('ui header').text('H4 - Hello, World').close()
					.h5().$class('ui header').text('H5 - Hello, World').close()
					.h6().$class('ui header').text('H6 - Hello, World').close()
				.close()
			.close()
			//Alert section
			.div().$class('row ui one column grid')
